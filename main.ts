...
class RecipeCategory {
    constructor(public categoryName: string, public recipes: Recipe[]) {}
...
class RecipeCatalog {
    ...
    addCategory(category: RecipeCategory) {
    ...
    getCategoryByName(name: string): RecipeCategory | undefined {
...
async function runRecipeCatalog(catalog: RecipeCatalog) {
    ...
    const ask = await inquirer.prompt({
        name: "Ask",
        type: "confirm",
        message: "Do you want to check more?"
    })
